...
class ArmorDetectionNode {
 public:
  ...
  void car1Info_sendCallback(const std_msgs::Float64MultiArray::ConstPtr& msg);
  void car2Info_sendCallback(const std_msgs::Float64MultiArray::ConstPtr& msg);
  void node2Info_sendCallback(const std_msgs::Float64MultiArray::ConstPtr& msg);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
  ...
  ros::Publisher marker_info_pub_;//发布视觉标签信息
  ros::Publisher block_info_pub;//发布块信息
  //////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  ros::Subscriber car1_info;//接收车坐标
  ros::Subscriber car2_info;//接收车坐标
  ros::Subscriber node2_info;//接收node2的消息
  //////////////////////////////////////////////////////////////////////////////////////////////////////
