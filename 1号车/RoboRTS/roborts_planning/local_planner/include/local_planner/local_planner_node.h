...
class LocalPlannerNode {
 public:
  ...
  void Loop();
////////////////////////////////
  void PosCallback(const geometry_msgs::PoseStamped::ConstPtr & stuck_pos);
  
  void nextgoalCallback(const geometry_msgs::PoseStamped::ConstPtr  & nextgoalmsg);
   bool IsStuck = false;
  ///////////////////////
  /**
...
//    //float z;
   ...
   double stuck_yaw;
     ...
     //stuck geometry_msgs::Twist cmd_vel_;
  //! robot control velocity with accelerate
  roborts_msgs::TwistAccel cmd_vel1_;
     //! stuck ros publisher
  ros::Publisher vel_pub1_;
      //! stuck ros node handle
  ros::NodeHandle local_planner_nh1_;
...
//    ros::NodeHandle local_init_h;
//     //! ROS Publisher for current goal
//     ros::Publisher local_init_pub_ = local_init_h.advertise<std_msgs::Float64 >("/local_init_info", 10);
      
//       
      ros::NodeHandle LOOP_h;
    ros::Publisher LOOP_pub=LOOP_h.advertise< geometry_msgs::PoseStamped>("/LOOP_info", 10);
       geometry_msgs::PoseStamped Loop_info;
// //       
