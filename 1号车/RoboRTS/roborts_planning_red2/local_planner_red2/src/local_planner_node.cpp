...
LocalPlannerNode::LocalPlannerNode() :
    local_planner_nh_("~"),
    as_(local_planner_nh_, "/local_planner_node_action_red2", boost::bind(&LocalPlannerNode::ExcuteCB, this, _1), false),
...
roborts_common::ErrorInfo LocalPlannerNode::Init() {
  ...
  std::string full_path = ros::package::getPath("roborts_planning_red2") + "/local_planner_red2/config/local_planner.prototxt";
  ...
  std::string map_path = ros::package::getPath("roborts_costmap_red2") + \
  ...
  vel_pub_ = local_planner_nh_.advertise<roborts_msgs::TwistAccel>("/cmd_vel_acc_red2", 5);
...
int main(int argc, char **argv) {
  ...
  ros::init(argc, argv, "local_planner_node_red2", ros::init_options::NoSigintHandler);
