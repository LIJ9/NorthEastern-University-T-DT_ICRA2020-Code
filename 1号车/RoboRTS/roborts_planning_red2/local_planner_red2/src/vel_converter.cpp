...
class VelConverter {
 public:
  VelConverter() : new_cmd_acc_(false), begin_(false) {
    ...
    cmd_pub_ = cmd_handle_.advertise<geometry_msgs::Twist>("/red_car2/cmd_vel", 5);
    cmd_sub_ = cmd_handle_.subscribe<roborts_msgs::TwistAccel>("/cmd_vel_acc_red2", 100, boost::bind(&VelConverter::VelCallback, this, _1));
  }
...
{
  ros::init(argc, argv, "vel_converter_red2");
