...
GlobalPlannerNode::GlobalPlannerNode() :
    ...
    as_(nh_,"global_planner_node_action_red2",boost::bind(&GlobalPlannerNode::GoalCallback,this,_1),false) {
...
ErrorInfo GlobalPlannerNode::Init() {
  ...
  std::string full_path = ros::package::getPath("roborts_planning_red2") + "/global_planner_red2/config/global_planner_config.prototxt";
...
int main(int argc, char **argv) {
  ...
  ros::init(argc, argv, "global_planner_node_red2");
