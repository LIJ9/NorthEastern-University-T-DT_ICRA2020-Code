...
const ::google::protobuf::Descriptor* Amors_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  Amors_reflection_ = NULL;
...
void protobuf_AssignDesc_armor_5fdetection_2eproto() {
  ...
  Amors_descriptor_ = file->message_type(3);
  static const int Amors_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Amors, armor_),
  };
  Amors_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      Amors_descriptor_,
      Amors::default_instance_,
      Amors_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Amors, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Amors, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(Amors));
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    Amors_descriptor_, &Amors::default_instance());
}
...
void protobuf_ShutdownFile_armor_5fdetection_2eproto() {
  ...
  delete Amors::default_instance_;
  delete Amors_reflection_;
}
...
void protobuf_AddDesc_armor_5fdetection_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "odelInfo\"C\n\005Amors\022:\n\005armor\030\001 \003(\0132+.robor"
    "ts_detection.ArmorDetectionAlgorithms", 557);
  ...
  Amors::default_instance_ = new Amors();
  ...
  Amors::default_instance_->InitAsDefaultInstance();
...
#ifndef _MSC_VER
const int Amors::kArmorFieldNumber;
#endif  // !_MSC_VER

Amors::Amors()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:roborts_detection.Amors)
}

void Amors::InitAsDefaultInstance() {
}

Amors::Amors(const Amors& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:roborts_detection.Amors)
}

void Amors::SharedCtor() {
  _cached_size_ = 0;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}

Amors::~Amors() {
  // @@protoc_insertion_point(destructor:roborts_detection.Amors)
  SharedDtor();
}

void Amors::SharedDtor() {
  if (this != default_instance_) {
  }
}

void Amors::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* Amors::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return Amors_descriptor_;
}

const Amors& Amors::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_armor_5fdetection_2eproto();
  return *default_instance_;
}

Amors* Amors::default_instance_ = NULL;

Amors* Amors::New() const {
  return new Amors;
}
...
bool Amors::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:roborts_detection.Amors)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // repeated .roborts_detection.ArmorDetectionAlgorithms armor = 1;
      case 1: {
        if (tag == 10) {
         parse_armor:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
        ...
        if (input->ExpectTag(10)) goto parse_armor;
        if (input->ExpectAtEnd()) goto success;
        break;
      }
...
success:
  // @@protoc_insertion_point(parse_success:roborts_detection.Amors)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:roborts_detection.Amors)
  return false;
#undef DO_
}

void Amors::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:roborts_detection.Amors)
  // repeated .roborts_detection.ArmorDetectionAlgorithms armor = 1;
  for (int i = 0; i < this->armor_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1, this->armor(i), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:roborts_detection.Amors)
}

::google::protobuf::uint8* Amors::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:roborts_detection.Amors)
  // repeated .roborts_detection.ArmorDetectionAlgorithms armor = 1;
  for (int i = 0; i < this->armor_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
        1, this->armor(i), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:roborts_detection.Amors)
  return target;
}

int Amors::ByteSize() const {
  int total_size = 0;
...
void Amors::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const Amors* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const Amors*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void Amors::MergeFrom(const Amors& from) {
  GOOGLE_CHECK_NE(&from, this);
  armor_.MergeFrom(from.armor_);
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}

void Amors::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void Amors::CopyFrom(const Amors& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool Amors::IsInitialized() const {

  if (!::google::protobuf::internal::AllAreInitialized(this->armor())) return false;
  return true;
}

void Amors::Swap(Amors* other) {
  if (other != this) {
...
::google::protobuf::Metadata Amors::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = Amors_descriptor_;
  metadata.reflection = Amors_reflection_;
  return metadata;
}
