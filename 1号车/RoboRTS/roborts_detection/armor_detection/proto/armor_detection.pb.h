...
class Amors : public ::google::protobuf::Message {
 public:
  Amors();
  virtual ~Amors();

  Amors(const Amors& from);

  inline Amors& operator=(const Amors& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const Amors& default_instance();

  void Swap(Amors* other);
  ...
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const Amors& from);
  void MergeFrom(const Amors& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline const ::roborts_detection::ArmorDetectionAlgorithms& armor(int index) const;
  inline ::roborts_detection::ArmorDetectionAlgorithms* mutable_armor(int index);
  inline ::roborts_detection::ArmorDetectionAlgorithms* add_armor();
  inline const ::google::protobuf::RepeatedPtrField< ::roborts_detection::ArmorDetectionAlgorithms >&
      armor() const;
  inline ::google::protobuf::RepeatedPtrField< ::roborts_detection::ArmorDetectionAlgorithms >*
      mutable_armor();

  // @@protoc_insertion_point(class_scope:roborts_detection.Amors)
 private:
  ...
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::roborts_detection::ArmorDetectionAlgorithms > armor_;
  friend void  protobuf_AddDesc_armor_5fdetection_2eproto();
  friend void protobuf_AssignDesc_armor_5fdetection_2eproto();
  friend void protobuf_ShutdownFile_armor_5fdetection_2eproto();

  void InitAsDefaultInstance();
  static Amors* default_instance_;
};
// ===================================================================
...
// repeated .roborts_detection.ArmorDetectionAlgorithms armor = 1;
inline int Amors::armor_size() const {
  return armor_.size();
}
inline void Amors::clear_armor() {
  armor_.Clear();
}
inline const ::roborts_detection::ArmorDetectionAlgorithms& Amors::armor(int index) const {
  // @@protoc_insertion_point(field_get:roborts_detection.Amors.armor)
  return armor_.Get(index);
}
inline ::roborts_detection::ArmorDetectionAlgorithms* Amors::mutable_armor(int index) {
  // @@protoc_insertion_point(field_mutable:roborts_detection.Amors.armor)
  return armor_.Mutable(index);
}
inline ::roborts_detection::ArmorDetectionAlgorithms* Amors::add_armor() {
  // @@protoc_insertion_point(field_add:roborts_detection.Amors.armor)
  return armor_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::roborts_detection::ArmorDetectionAlgorithms >&
Amors::armor() const {
  // @@protoc_insertion_point(field_list:roborts_detection.Amors.armor)
  return armor_;
}
inline ::google::protobuf::RepeatedPtrField< ::roborts_detection::ArmorDetectionAlgorithms >*
Amors::mutable_armor() {
  // @@protoc_insertion_point(field_mutable_list:roborts_detection.Amors.armor)
  return &armor_;
}
