...
struct LocalizationConfig {
  void GetParam(ros::NodeHandle *nh) {
      nh->param<std::string>("odom_frame", odom_frame_id, "red_car2/odom");
      nh->param<std::string>("base_frame", base_frame_id, "red_car2/base_link");
      nh->param<std::string>("global_frame", global_frame_id, "map");
      nh->param<std::string>("laser_topic_name", laser_topic_name, "scan_red2");
      ...
      nh->param<double>("initial_pose_y", initial_pose_y, 3.98);
